...
В правом верхнем углу доступен переключатель вариантов авторизации в системе "Честный знак":
- JWT;
- Универсальный токен (United).

Для дальнейшей работы необходимо указать в настройках, какие товарные категории будут подвергаться маркировке. Впоследствии эти категории будут доступны при заведении номенклатуры и проведении дальнейших операций взаимодействия с системой «Честный знак». 

![](Settings_ChZ.assets/Screenshot_16.png)